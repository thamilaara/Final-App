            ...
            <nav className="navbar row">
                <div className="col-12 col-md-3">
                    <div className="navbar-brand">
                        <Link to="/">
                            <img src="/images/relogo.png" width="150" />
                        </Link>
                    </div>
                </div>
          ...
          <div className='row'>
            <div className='col-5 '>
              <img style={{width:'700%', height:'100%'}}
                src='https://www.99images.com/download-image/930548/1177x752'
                alt=''
                className='img-fluid'
            ...
            <div className='col-7  my-auto pb-5'>
              ...
              <h1 className='fw-bold  display-5'>BROWSE OUR a style={{backgroundColor:"red"}}MIUM PRODUCT</h1>
              <p>
